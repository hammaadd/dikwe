<input type="text" placeholder="Tag Title" class="input---field">
<textarea name="" id="" rows="3" placeholder="Tag Description..." class="input---field"></textarea>
...
<div class="text-center my-4">
    <button class="btn-green"><i class="far fa-copy"></i>Copy</button>
</div>
