...
<div class="py-2" x-data="{ tab:'stat' }">
    <ul class="w-full flex overflow-y-hidden mb-3 justify-center">
        ...
        <li class="ws-tab-item bg-yellow-350" :class="{'ws-tab--active':tab==='auth'}" @click="tab='auth'"> <i class="fas fa-users mr-2"></i> Authorized Users</li>
    </ul>
    ...
    <div class="w-full px-2" x-show="tab==='auth'">
        <x-ws-auth />
    </div>
</div>
