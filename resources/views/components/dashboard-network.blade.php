<h3 class=" text-lg font-bold pl-2 mb-2 md:mb-0"><i class="fas fa-users text-green-550 pr-2"></i> YOUR NETWORK</h3>
<div class="bg-white rounded-xl md:p-5 lg:px-0 xl:p-5 height-28" x-data="{ tab:'following' }">
    ...
    <div class=" text-center md:text-right px-4 pt-4">
        <a href="{{route('network')}}" class=" font-bold text-green-550 link-hover">Open Network</a>
    </div>
</div>
