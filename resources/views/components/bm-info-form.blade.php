<input type="text" placeholder="Bookmark Title" class="input---field">
<input type="text" placeholder="Bookmark URL" class="input---field">
<textarea name="" id="" rows="3" placeholder="Bookmark Note" class="input---field"></textarea>
