<input type="text" placeholder="Workspace Title" class="input---field">
<textarea name="" id="" rows="3" placeholder="Workspace Description..." class="input---field"></textarea>
<div class="input---field">
    <i class="fas fa-cloud-download-alt mr-2"></i>Cloud Storage
    <input type="checkbox" checked class="form-checkbox text-green-550 border-green-550 bg-green-550 rounded-full focus:ring-0 float-right mt-1" />
</div>
