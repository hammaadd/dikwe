<h3 class=" text-lg font-bold pl-2 mb-2 md:mb-0"><i class="fas fa-tags fa-flip-horizontal text-green-550 pl-2"></i> TAGS</h3>
<div class="bg-green-150 rounded-xl md:p-5 lg:px-2 xl:p-5 lg:height-28" x-data="{ tab:'mytags' }">
