                    ...
                    <div class="bg-white pb-5 rounded-xl h-full mt-4 lg:mt-0">
                        ...
                        <div class="w-full px-2 md:px-5 lg:px-2 xl:px-5 flex flex-wrap justify-between relative" x-data="{ isOpen: false, fOpen: false }">
                            <div class="mx-auto md:mx-0">
                                ...
                                <button class="bg-green-550 text-white font-bold py-2 px-3 mx-2 rounded-xl hover:bg-green-550 hover:text-white focus:outline-none"><i class="fas fa-star mr-2"></i><span class="hidden xl:inline-block">Bookmarks</span> <span class="counts md:ml-3">2</span></button>
