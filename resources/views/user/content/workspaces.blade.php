                ...
                <div class="w-full overflow-hidden lg:px-4 lg:w-2/3 xl:px-4 xl:w-2/3">
                    ...
                    <div class="bg-white pb-5 rounded-xl h-full">
                        <div class="flex flex-wrap justify-between relative" x-data="{ isOpen: false }">
                            <div class="bg-green-550 text-white font-bold px-8 py-3 br-top-left"><label for="knowledge-assets">13 Knowledge Assets</label></div>
                        ...
                        <div class="w-full px-5 flex flex-wrap justify-between relative" x-data="{ isOpen: false, fOpen: false }">
                            ...
                            <div>
                                ...
                                <button @click=" fOpen = !fOpen " class="text-gray-400 bg-green-150 rounded-xl mx-1 px-2 h-10 w-10 hover:text-green-550 focus:outline-none">
                                    <i class="fas fa-sliders-h text-xl align-middle"></i>
                                </button>
                                <button @click=" isOpen = !isOpen " class="text-gray-400 bg-green-150 rounded-xl mx-1 px-2 h-10 w-10 hover:text-green-550 focus:outline-none">
                            ...
                            <form action="" class="absolute bg-white shadow overflow-hidden rounded-xl w-72 mt-2 py-1 right-0 top-10 z-20">
                                <p class="font-bold text-center">Filter By</p>
                                <div class="flex items-center border-b border-gray-500 py-6">
