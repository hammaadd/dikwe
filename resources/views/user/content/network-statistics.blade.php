        ...
        <div class="bg-green-150 rounded-xl p-8">
            <div class="flex flex-wrap overflow-hidden lg:-mx-4 xl:-mx-4">
                ...
                <div class="w-full overflow-hidden lg:px-4 lg:w-2/5 xl:px-4 xl:w-2/5">
                    <!-- Column Content -->
                    {{-- Network Section --}}
                    <div class="bg-white px-6 py-5 rounded-xl h-full max-h-full overflow-y-scroll">
                        <x-network-group/>
                    </div>
                </div>
                        ...
                        <div class="pt-5">
                            <div class="w-full flex flex-wrap items-center overflow-hidden ">
                                ...
                                <div class=" w-full md:w-1/5 p-3">
                                    <img src="{{asset('images/Ellipse 1792x.png')}}" alt="" class="w-full">
                                </div>
                                <div class="w-full md:w-4/5 flex flex-col pl-2">
                                    ...
                                    <div class=" w-full">
                                        ...
                                        <span class="ml-3"><a href="#"><i class="fas fa-link"></i> www.twitter.com</a></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:px-10 gap-5 mt-5">
                                <div class="bg-green-150 px-6 py-3 rounded-xl">
                                    <ul>
                                        <li class="font-bold text-lg my-3 hover:text-green-550"><a href="#"><span class="stat-count">30</span>Following</a></li>
                                        <li class="font-bold text-lg my-3 hover:text-green-550"><a href="#"><span class="stat-count">10</span>Followers</a></li>
                                        <li class="font-bold text-lg my-3 hover:text-green-550"><a href="#"><span class="stat-count">10</span>Service Users</a></li>
                                    </ul>
                                </div>
                                <div class="bg-green-150 px-6 py-3 rounded-xl">
                                    <ul>
                                        <li class="font-bold text-lg my-3 hover:text-green-550"><a href="#"><span class="stat-count">30</span>Tags</a></li>
                                        <li class="font-bold text-lg my-3 hover:text-green-550"><a href="#"><span class="stat-count">10</span>Workspaces</a></li>
                                        <li class="font-bold text-lg my-3 hover:text-green-550"><a href="#"><span class="stat-count">30</span>Notes</a></li>
                                    </ul>
                                </div>
                                <div class="bg-green-150 px-6 py-3 rounded-xl sm:col-span-2 sm:mx-auto">
                                    <ul>
                                        <li class="font-bold text-lg my-3 hover:text-green-550"><a href="#"><span class="stat-count">10</span>Bookmarks</a></li>
                                        <li class="font-bold text-lg my-3 hover:text-green-550"><a href="#"><span class="stat-count">10</span>Short URLs</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
