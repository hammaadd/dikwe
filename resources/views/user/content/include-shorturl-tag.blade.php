...
@section('title','Include Short URL in Tags')
                ...
                <div class="w-full overflow-hidden lg:px-4 lg:w-2/3 xl:px-4 xl:w-2/3">
                    ...
                    <div class="bg-white pb-5 rounded-xl lg:h-full mt-4 lg:mt-0">
                            ...
                            <div class="flex flex-wrap justify-between relative">
                                <div class="bg-green-550 text-white font-bold px-2 md:px-8 py-1 md:py-3 br-top-left"><label for="tag">Include Short URL</label></div>
                            </div>
