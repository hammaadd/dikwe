<div class="mt-2 mx-auto md:mx-0 px-3"  >
    ...
    <button  :class="{'text-green-550':fOpen}" x-on:click=" isOpen=!isOpen" class="text-gray-400 bg-green-150 rounded-xl mx-1 px-2 h-10 w-10 hover:text-green-550 focus:outline-none">
