...
<div class="w-full bg-white py-2 px-5 flex flex-wrap items-center justify-between my-2 rounded-xl shadow-md">
    ...
    <div class="flex flex-wrap items-center">
        ...
        <button class=" bg-green-150 text-gray-400 text-sm rounded-full px-2 py-1 hover:bg-green-550 hover:text-white focus:outline-none" x-on:click="{showEdit=true}" wire:click="passTagId({{$tag->id}})">
