...
@endisset
                                    ...
                                    <div class="flex items-center justify-center space-x-3 my-3">
                                        ...
                                        <a @isset($note->id) href="https://www.facebook.com/sharer/sharer.php?u={{route('view.note',$note->id)}}&t={{$note->title}}" @endisset class="border-blue-600 border-2 px-4 py-2 font-semibold text-blue-600 inline-flex items-center space-x-2 rounded">
                                        ...
                                        <a @isset($note->id) href="https://www.twitter.com/share?url={{route('view.note',$note->id)}}&text={{$note->title}}" @endisset class="border-blue-400 border-2 px-4 py-2 font-semibold text-blue-400 inline-flex items-center space-x-2 rounded">
                                        ...
                                        <a @isset($note->id) href="https://www.facebook.com/sharer/sharer.php?u={{route('view.note',$note->id)}}&t={{$note->title}}" @endisset class=" border-red-600 border-2 px-4 py-2 font-semibold text-red-600 inline-flex items-center space-x-2 rounded">
